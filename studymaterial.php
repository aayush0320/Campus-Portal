  ...
  <div id="pageintro" class="hoc clear"> 
    ...
    <article>
      <div class="overlay inspace-30 btmspace-30">
        ...
        <h2 class="heading">Study Material</h2>
        <p><h3>Learn. Interact. Connect.</h3>
		The Purpose of Study Material is to organize lecture notes and text book material so that you can increase your comprehension and memory of    large amounts of information. Preparing study guides that are visual is even more effective, as the visual organization helps you see related concepts    and make meaningful connections with the material, thus acquiring the higher levels of learning expected by many of your professors.<br><br>
