    ...
    <nav id="mainav" class="fl_right">
      <ul class="clear">
        <li><a href="#">Pages</a>
		 ...
		 <li class="active"><a href="file_upload.php">Upload</a></li>
  ...
  <div id="pageintro" class="hoc clear"> 
    ...
    <article>
      <div class="overlay inspace-30 btmspace-30">
        ...
        <h2 class="heading">Question Bank</h2>
        <p><h3>Learn. Interact. Connect.</h3>
		Questioning is the most important device of teaching. The teacher keeps in close touch with his class by means of questioning. The teaching- learning process becomes effective, when knowledge is given and shares in the class; through this questioning. The teacher can know the amount of knowledge acquired by the students with the help of questioning. It helps the child to keep him alert and attentive. It helps to encourage thought and thus stimulates curiosity. Questions are asked to fix the lesson clearly in the mind of the child and to know whether he is following the steps of the lesson or not.<br><br>
